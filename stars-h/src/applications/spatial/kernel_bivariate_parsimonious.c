 ...
 *
 * @file src/applications/spatial/kernel_bivariate_matern.c
 * @version 0.1.1
...
void starsh_ssdata_block_bivariate_parsimonious_kernel_@NDIMd(int nrows, int ncols,
...
void starsh_ssdata_block_bivariate_parsimonious_kernel_@NDIMd_simd(int nrows, int ncols,
		STARSH_int *irow, STARSH_int *icol, void *row_data, void *col_data,
		void *result, int ld)
	//! Mat&eacute;rn kernel for @NDIM-dimensional spatial statistics problem
	/*! Fills matrix \f$ A \f$ with values
