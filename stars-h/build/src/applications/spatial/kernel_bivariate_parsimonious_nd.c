 ...
 *
 * Generated from file /home/abdullsm/develop/stars-h/src/applications/spatial/kernel_bivariate_parsimonious.c with NDIM=n
 ...
 * During code generation step, each appearance of n (including this one)
 * will be replace by proposed values. If you want to use this file outside
 * STARS-H, simply do substitutions yourself.
 *
 * @file /home/abdullsm/develop/stars-h/build/src/applications/spatial/kernel_bivariate_parsimonious_nd.c
 * @version 0.1.1
...
void starsh_ssdata_block_bivariate_parsimonious_kernel_nd(int nrows, int ncols,
        STARSH_int *irow, STARSH_int *icol, void *row_data, void *col_data,
        void *result, int ld)
//! Mat&eacute;rn kernel for n-dimensional spatial statistics problem
...
void starsh_ssdata_block_bivariate_parsimonious_kernel_nd_simd(int nrows, int ncols,
		STARSH_int *irow, STARSH_int *icol, void *row_data, void *col_data,
		void *result, int ld)
	//! Mat&eacute;rn kernel for n-dimensional spatial statistics problem
	/*! Fills matrix \f$ A \f$ with values
