...
void MORSE_dmle_mloe_mmom_Tile(MLE_data *MORSE_data, double * truth_theta, double* estimatedtheta, int nZmiss, int nZobs, int n);

void MORSE_dmle_mloe_mmom_Tile_Async(MLE_data *MORSE_data, double * truth_theta, double* estimatedtheta, int nZmiss, int nZobs, int n);
#endif
